...
df.adult_train = read.table("Datasets//adult_train.data", sep = ",", strip.white = TRUE, col.names = colnames(df.adult.full))
df.adult_train$train_test_split = "train"
df.adult_test = read.table("Datasets//adult_test.data", sep = ",", strip.white = TRUE, col.names = colnames(df.adult.full))
...
nrow(df.adult_train)
nrow(df.adult_test)
nrow(df.adult_train) + nrow(df.adult_test)
nrow(df.adult.full)
