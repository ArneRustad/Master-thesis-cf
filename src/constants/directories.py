...
images_hp_v6 = lambda: os.path.join(images(), "hyperparameter_tuning_v6")
images_hp_v7 = lambda: os.path.join(images(), "hyperparameter_tuning_v7")
images_hp_v8 = lambda: os.path.join(images(), "hyperparameter_tuning_v8")
