...
print("Starting v4 hyperparameter tuning on Idun")
...
hp_name_vec = ["qtr_spread",
               #"oh_encoding_choices", "add_connection",
               "add_connection_advanced", "activation_function",
               #"qt_distribution", "qt_transformation", "oh_encoding_activation_function", "reapply_qtr_continuously",
               "spread_and_activation", "spread_and_activations", #Count 5
               "qtr", "qtr_distribution_beta_param", "adam_beta1"]
hp_name_restart_vec = []
